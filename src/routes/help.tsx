...
const topics = [
  ...
  { title: "What do the file badges mean?", body: "Print-Tested — the creator physically printed the model and attached a photo of the real print. Digital Sculpt — hand-crafted digitally, watertight (manifold) and scaled for slicers, but not yet test-printed. AI-Assisted — built from a 3D AI base, then retopologised, repaired and refined by hand. Falsifying a badge is a Terms violation and can get a file removed or an account suspended." },
  { title: "What is Printreon's policy on AI-generated models?", body: "Raw AI output is banned. Direct, unedited exports from text-to-3D or image-to-3D tools cannot be published here. If AI was used anywhere in the process, the file must be manually repaired, retopologised, manifold-checked and scaled for slicers, and it must carry the AI-Assisted badge. We'd rather have fewer files that actually print than a library full of unprintable slop." },
